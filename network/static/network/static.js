        ...
        fetch(`/network/edit/${post_id}`, {
          ...
          .then(result => {
              if (result.status == 201) {
                ...
                document.querySelector(`#post-body-${post_id}`).innerHTML = new_body;
              }
          });
        return false
    }
